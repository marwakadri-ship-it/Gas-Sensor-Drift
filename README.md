...
│   ├── baseline_vs_pca_accuracy.png         # Part 2 — main result figure
│   ├── confusion_matrix_f1_comparison.png   # Part 2 — confusion matrix + F1
│   ├── drift_vs_importance_insight.png      # Part 2 — key scientific finding
│   ├── predictive_maintenance_forecast.png  # Part 3 — replacement schedule
│   ├── regression_results.png               # Part 3 — regression fit & residuals
│   └── accuracy_per_gas.png                 # Part 3 — per-gas accuracy
│
└── README.md
```
...
![Accuracy degradation curve](figures/baseline_vs_pca_accuracy.png)
